...
//Listar todas las mesas de forma paginada o no paginada
export const getAllMesas = async (req: Request, res: Response) => {
    const esPaginado = req.query.esPaginado === "true";
    console.log(typeof esPaginado,esPaginado);

    if (esPaginado) { //Listar todas las mesas de forma paginada
